      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-start lg:items-center">
          ...
          >
            <div className="text-center lg:text-left">
              <h3 className="text-xl sm:text-2xl font-bold text-red-600 mb-4 flex items-center justify-center lg:justify-start">
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="flex items-start space-x-3 sm:space-x-4 p-3 sm:p-4 bg-red-50 rounded-lg border border-red-200">
                <X className="h-5 w-5 sm:h-6 sm:w-6 text-red-600 mt-1 flex-shrink-0" />
                <div>
          ...
          >
            <div className="text-center lg:text-left">
              <h3 className="text-xl sm:text-2xl font-bold text-green-600 mb-4 flex items-center justify-center lg:justify-start">
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="flex items-start space-x-3 sm:space-x-4 p-3 sm:p-4 bg-green-50 rounded-lg border border-green-200">
              ...
              <div className="flex items-start space-x-3 sm:space-x-4 p-3 sm:p-4 bg-green-50 rounded-lg border border-green-200">
                <FileText className="h-5 w-5 sm:h-6 sm:w-6 text-green-600 mt-1 flex-shrink-0" />
                <div>
              ...
              <div className="flex items-start space-x-3 sm:space-x-4 p-3 sm:p-4 bg-green-50 rounded-lg border border-green-200">
                <DollarSign className="h-5 w-5 sm:h-6 sm:w-6 text-green-600 mt-1 flex-shrink-0" />
                <div>
        ...
        >
          <div className="bg-blue-600 text-white p-6 sm:p-8 rounded-2xl">
            <h3 className="text-xl sm:text-2xl font-bold mb-4">Ready to Transform Your Practice?</h3>
            ...
            <button 
              className="bg-white text-blue-600 px-6 sm:px-8 py-3 rounded-lg font-semibold hover:bg-blue-50 transition-colors text-sm sm:text-base w-full sm:w-auto"
