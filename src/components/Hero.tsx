...
export default function Hero() {
  return (
    <section className="relative bg-gradient-to-br from-blue-50 via-white to-teal-50 py-12 sm:py-16 lg:py-20 px-4">
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-4 sm:p-6 lg:p-8 border border-gray-200">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-center justify-between">
                  <h3 className="text-base sm:text-lg font-semibold text-gray-900">Dashboard Overview</h3>
                ...
                <div className="grid grid-cols-4 gap-1 sm:gap-2">
                  {Array.from({ length: 16 }).map((_, i) => (
                    <div 
                      key={i} 
                      className={`h-8 sm:h-10 lg:h-12 rounded-lg flex items-center justify-center text-xs font-medium ${
                ...
                <div className="grid grid-cols-2 gap-2 sm:gap-4">
                  ...
                  <div className="bg-green-50 p-3 sm:p-4 rounded-lg">
                    <div className="text-lg sm:text-xl lg:text-2xl font-bold text-green-600">₹45K</div>
